...
public class NeighbourMedical extends MainActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setText(getString(R.string.doctor1));
   ...
   //             markers.get(2).hideInfoWindow();
        ...
        go_to_object1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(android.content.Intent.ACTION_VIEW,
                        Uri.parse(getString(R.string.direction_doc1)));
        ...
        button2.setText(getString(R.string.doctor2));
...
//                markers.get(2).hideInfoWindow();
        ...
        go_to_object2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(android.content.Intent.ACTION_VIEW,
                        Uri.parse(getString(R.string.direction_doc2)));
                startActivity(intent);
            }
        });
...
//        button3.setText(R.string.doctor3);
...
//                Intent intent = new Intent(android.content.Intent.ACTION_VIEW,
//                        Uri.parse(getString(R.string.direction_doc3)));
//                startActivity(intent);
//            }
//        });
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng doc1 = new LatLng(50.115443, 14.462022);
        LatLng doc2 = new LatLng(50.081710, 14.447898);
        ...
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(prg14, 12.0f));
        markerPrg14.showInfoWindow();

        //adds markers of ATMs
        Marker marker0 = mMap.addMarker(new MarkerOptions()
                .position(doc1)
                .title(getString(R.string.doctor1))
                .snippet("Budínova 2, Praha 8")
        ...
        Marker marker1 = mMap.addMarker(new MarkerOptions()
                .position(doc2)
                .title(getString(R.string.doctor2))
                .snippet("Kubelíkova 16/1250, Praha 3")
                .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_RED)));

//        Marker marker2 =  mMap.addMarker(new MarkerOptions()
//                .position(atm3)
//                .title(getString(R.string.doctor3))
//                .snippet("Čumpelíkova 1764/2, Praha 8")
//                .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_RED)));
